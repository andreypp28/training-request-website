    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <!--<li class="dropdown <?php echo $top_menu_item=='sessions'?'active':'';?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Training Sessions<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li class="<?php echo $top_menu_item=='session'?'active':'';?>">
                            <a href="<?php echo site_url('admin/sessions'); ?>">All Sessions</a>
                        </li>
                        <li class="<?php echo $top_menu_item=='types'?'active':'';?>">
                            <a href="<?php echo site_url('admin/types'); ?>">Session Types</a>
                        </li>
                        <li class="<?php echo $top_menu_item=='amenities'?'active':'';?>">
                            <a href="<?php echo site_url('admin/amenities'); ?>">Session Features</a>
                        </li>
                        <li class="<?php echo $top_menu_item=='marker'?'active':'';?>">
                            <a href="<?php echo site_url('admin/marker'); ?>">Maker</a>
                        </li>
                    </ul>
                </li>                
                
                <li class="dropdown <?php echo $top_menu_item=='locations'?'active':'';?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Locations<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?php echo base_url('admin/suburbs'); ?>">Suburbs</a>
                        </li>                
                        <li>
                            <a href="<?php echo base_url('admin/regions'); ?>">Regions</a>
                        </li>
                    </ul>
                </li>-->                
                ...
                <li class="<?php echo $top_menu_item=='packages'?'active':'';?>">
                    <a href="<?php echo base_url('admin/packages'); ?>">Packages</a>
                </li>-->
