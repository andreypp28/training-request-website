...
class Trainer extends Authenticated_Controller {
	...
	public function index()
	{
        ...
        $services = $this->service_model
            ->format_dropdown('service_id', 'service_name');
        Template::set('services', $services);
        
        //get all areas 
        $areas = $this->area_model
            ->format_dropdown('area_id', 'area_name');
        Template::set('areas', $areas);
        
        //get my services
        $my_services = $this->trainer_model
            ->get_services($this->current_user->id);
        Template::set('my_services', $my_services);

        //get my areas
        $my_areas = $this->trainer_model
            ->get_areas($this->current_user->id);
    ...
    public function request($code)
    {
        ...
        $quote_nums = $this->request_quote_model
        ...
        $myquote = $this->request_quote_model
            ->find_by($where);
