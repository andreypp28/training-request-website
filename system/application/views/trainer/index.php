...
<p>Select services and areas that you are available;</p>
...
<?php echo form_open($this->uri->uri_string(), array('class' => "form-horizontal", 'autocomplete' => 'off')); ?>
    ...
    <?php echo form_dropdown('my_areas[]', $areas, set_value('my_areas', $my_areas), 'Areas', 'multiple class="chosen-select" data-placeholder="" style="width:350px;"'); ?>
