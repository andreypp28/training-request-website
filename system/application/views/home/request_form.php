    ...
    <div class="row">                                
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-6">
            <div class="col-xs-12 marker">
                ...
                <input id="area_code" name="area_code" type="number" placeholder="Area Code" class="requestfields" min="1" max="9999" maxlength="4" required>
            </div>                
        </div>
    ...
    <div class="row">                                
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-6">
            <div class="col-xs-12 marker">
                ...
                <input id="requestor_email" name="requestor_email" type="email" placeholder="Your Email" class="requestfields" maxlength="24" required>
            </div>                
        </div>
    </div>
